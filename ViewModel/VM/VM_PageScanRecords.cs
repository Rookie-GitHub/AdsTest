...
namespace ViewModel
{
    public class VM_PageScanRecords : VM_BaseViewModel
    {
        ...
        public void Refresh()
        {
            while (true)
            {
                ...
                LoadData(DataGrid.CurrentPage, DataGrid.Station, DataGrid.Scan_Type, this.UIElementName);
            }
        }
        ...
        public void LoadData(int page, string Station, string Type, string PageName)
        {
            List<ScanLogViewModel> lis_ScanLog = new List<ScanLogViewModel>();

            //ScanLogInfo.GetScanLogInfo(null, Station, Type, "", "", "", true, page, DataGrid.SkipNumber, (list, count, msg) =>
            //{
            //    if (list == null)
            //        return;
            //    list.ForEach(s =>
